...
export const metadata: Metadata = {
  title: 'معلومات عنا - بيت السجاد',
  description: 'تعرف على بيت السجاد، الشركة الرائدة في مجال الأرضيات والمفروشات المنزلية. نقدم أحدث التصاميم بأعلى معايير الجودة والأسعار التنافسية.',
  keywords: [
    'معلومات عن بيت السجاد',
  ...
  openGraph: {
    title: 'معلومات عنا - بيت السجاد',
    description: 'تعرف على بيت السجاد، الشركة الرائدة في مجال الأرضيات والمفروشات المنزلية',
    type: 'website',
    locale: 'ar_SA',
  },
  robots: {
