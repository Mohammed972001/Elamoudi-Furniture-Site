          ...
          <div className="prose prose-lg max-w-none text-right" dir="rtl">
            ...
            <section className="mb-12 bg-gray-50 p-8 rounded-lg">
              ...
              <p className="text-lg leading-relaxed text-gray-700">
                في العمودي للأرضيات والمفروشات، نؤمن بأن اختيار الأرضيات والمفروشات المناسبة يُحدث فرقًا كبيرًا في جمال وأناقة أي مكان. لذلك، نلتزم بتقديم منتجات ذات جودة عالية بأسعار تنافسية. علاوة على ذلك، نهدف إلى تحسين تجربة عملائنا من خلال تقديم خدمات استشارية تساعدهم في اتخاذ أفضل القرارات وفقًا لاحتياجاتهم.
              </p>
            </section>
            ...
            <section className="text-center bg-carpet-gold p-8 rounded-lg">
              <h2 className="text-3xl font-bold text-white mb-4">
                📍 زورونا اليوم واكتشفوا التميز مع العمودي للأرضيات والمفروشات
              </h2>
