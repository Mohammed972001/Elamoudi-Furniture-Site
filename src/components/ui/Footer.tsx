...
const Footer = () => {
  ...
  const navigationLinks: NavigationSection[] = [
    ...
    {
      title: "معلومات",
      description: "لمسة ابداع لمفروشات الرياض هو وجهتك الأولى لحلول الأرضيات والمفروشات الفاخرة، حيث نقدم تشكيلة واسعة من الموكيت والسجاد بأعلى المواصفات العالمية. نحن نحرص على تلبية احتياجات جميع القطاعات بأفضل الأسعار وأعلى جودة، مع تقديم خدمات متميزة لما بعد البيع، وفريق متخصص جاهز لخدمتك وزيارتك أينما كنت",
      links: []
    },
    {
      title: "من نحن",
        ...
        <div className="block lg:hidden">
          ...
          <div className="text-center mb-8">
            <div className="flex items-center justify-center mb-4">
              ...
              <h2 className="text-2xl font-bold">لمسة ابداع لمفروشات الرياض</h2>
            </div>
        ...
        <div className="hidden lg:grid lg:grid-cols-4 lg:gap-8">
          ...
          <div className="text-right">
            ...
            <div className="w-10 h-12 flex items-center justify-center">
              ...
              <h2 className="text-2xl font-bold mr-3">لمسة ابداع لمفروشات الرياض</h2>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
          ...
          <div className="flex items-center space-x-8 space-x-reverse">
            ...
            <p className="text-gray-200 text-sm">
              جميع الحقوق محفوظة ©   لمسة ابداع لمفروشات الرياض  {currentYear}
            </p>
          </div>
        </div>
      </div>
